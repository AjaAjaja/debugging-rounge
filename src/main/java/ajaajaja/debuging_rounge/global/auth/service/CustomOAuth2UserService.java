package ajaajaja.debuging_rounge.global.auth.service;

import ajaajaja.debuging_rounge.domain.user.entity.User;
import ajaajaja.debuging_rounge.domain.user.service.UserService;
import ajaajaja.debuging_rounge.global.auth.SocialType;
import ajaajaja.debuging_rounge.global.auth.oauth.CustomOAuth2User;
import ajaajaja.debuging_rounge.global.auth.oauth.OAuth2UserInfo;
import ajaajaja.debuging_rounge.global.auth.oauth.OAuth2UserInfoFactory;
